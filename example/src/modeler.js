...
import ConstraintModdleExtension from '../../lib/features/constraint-flow/constraints.json';
...
const modeler = new BpmnModeler({
  container: '#canvas',
  moddleExtensions: {
    constraint: ConstraintModdleExtension
  },
  additionalModules: [
    BpmnPropertiesPanelModule,
    BpmnPropertiesProviderModule,
...
// export function sendXMLtoMonitor() {
